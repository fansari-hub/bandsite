let bandsiteComments = 
{
    ...
    postComment : function(strUsername, strComment) {
        this.comments.push({username: strUsername, timestamp: Date.now(), comment: strComment})
    ...
    initalizeComments: function (){
        this.comments[0] = ({username: "Victor Pinto",       timestamp: Date.parse("02 Nov 2023 00:00:00 GMT"),  comment: "This is art. This is inexplicable magic expressed in the purest way, everything that makes up this majestic work deserves reverence. Let us appreciate this for what it is and what it contains."});
        this.comments[1] = ({username: "Christina Cabrera",  timestamp: Date.parse("28 Oct 2023 00:00:00 GMT"),  comment:"I feel blessed to have seen them in person. What a show! They were just perfection. If there was one day of my life I could relive, this would be it. What an incredible day."});
        this.comments[2] = ({username: "Isaac Tadesse",      timestamp: Date.parse("20 Oct 2023 00:00:00 GMT"),  comment:"I can't stop listening. Every time I hear one of their songs - the vocals - it gives me goosebumps. Shivers straight down my spine. What a beautiful expression of creativity. Can't get enough."});
    ...
    getRelativeTime: function(time){
        ...
        let lookup_plural = ["years", "months", "weeks", "days", "hours", "minutes", "seconds"];
        let lookup_singular = ["year", "month", "week", "day", "hour", "minute", "second"];
        let values = [];
        ...
        for(var i=0 ; i <values.length; i++){
            ...
            if (val == 1)
                prettyTime += val + " " + lookup_singular[i] + " ago";
            else 
                prettyTime += val + " " + lookup_plural[i] + " ago";
